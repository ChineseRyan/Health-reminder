...
export default {
  ...
  app: {
    ...
    footer: 'Health Reminder v1.5.3 · Wishing you good health every day',
  ...
  settings: {
    ...
    currentVersion: 'Current version v1.5.3',
    newVersion: 'Current version v1.5.3 (New version v{version} available)',
    language: 'Language',
  },
